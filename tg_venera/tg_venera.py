...
def start(message):
    ...
    if chat_id not in session:
        session[chat_id] = {'flag_admin': False, 'flag1': False, 'flag2': False, 'flag3': False, 'flag4': False, 'flag5': False, 'flag6': False, 'flag7': False, 'flag8': False, 'flag9': False, 'flag10': False, 'flag11': False, 'flag12': False, 'fio': '', 'dr': '', 'ds': '', 'mr': '', 'ms': '', 'supr': '', 'obr': '', 'rd': '', 'graj': '', 'deti': '', 'vnuki': '', 'dost': '', 'deys': ''}
...
{main(session[chat_id]['fio'], session[chat_id]['dr'], session[chat_id]['ds'], session[chat_id]['mr'], session[chat_id]['ms'], session[chat_id]['supr'], session[chat_id]['obr'], session[chat_id]['rd'], session[chat_id]['graj'], session[chat_id]['deti'], session[chat_id]['vnuki'], session[chat_id]['dost'], session[chat_id]['deys'])}''', reply_markup=kb)
...
def info(message):
    ...
    if session[chat_id]['flag1']:
        ...
        kb = types.ReplyKeyboardMarkup(resize_keyboard = True)
        btn72 = types.KeyboardButton(text = f'Другая {deys}🔄')
